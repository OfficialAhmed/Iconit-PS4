...
class Ui_ProfileIconWin(object):
    def setupUi(self, ProfileIconWin, allUsers, IP, Port, w, h):
        ...
        sizePolicy.setHeightForWidth(ProfileIconWin.sizePolicy().hasHeightForWidth())
        ...
        self.line_2.setStyleSheet("border-image: url("+ self.convert2Url(self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        self.Change_DownloadBtnLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.Change_btn)
        ...
        self.Change_DownloadBtnLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.Download_btn)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ResizeUpload_btn.sizePolicy().hasHeightForWidth())
        ...
        self.RightLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.AccountName)
        self.AccountID_label = QtWidgets.QLabel(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.AccountID_label.sizePolicy().hasHeightForWidth())
        ...
        self.RightLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.AccountID_label)
        ...
        self.line_3.setStyleSheet("border-image: url("+ self.convert2Url(self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        self.RightLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.TotalAccount_label)
        ...
        self.RightLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.TotalAccounts)
        self.line_4 = QtWidgets.QFrame(ProfileIconWin)
        self.line_4.setMinimumSize(QtCore.QSize(100, 3))
        self.line_4.setStyleSheet("border-image: url("+ self.convert2Url(self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        self.Originalcon.setStyleSheet("border-image: url("+ self.convert2Url(self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        self.Originalcon.setObjectName("Originalcon")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.Originalcon)
        self.RightLayout.setLayout(5, QtWidgets.QFormLayout.LabelRole, self.formLayout_2)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.firstName_label)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lastName_label)
        ...
        self.RightLayout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.formLayout_3)
        ...
        self.line_6.setStyleSheet("border-image:url("+ self.convert2Url(self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        ProfileIconWin.setStyleSheet("background-image: url("+ self.convert2Url(self.AppSettingDir + "Pref\\" + background) +");")
    ...
    def retranslateUi(self, ProfileIconWin):
        ...
        ProfileIconWin.setWindowTitle(_translate("ProfileIconWin", "Iconit v"+ str(self.ver)))
        ...
        self.Download_btn.setText(_translate("ProfileIconWin", "Download Avatar"))
        ...
        self.AccountName.setText(_translate("ProfileIconWin", self.getAccountName()))
        self.AccountID_label.setText(_translate("ProfileIconWin", "AccountID:"))
        ...
        self.label1.setText(_translate("ProfileIconWin", "This is the Original Avatar."))
        self.label2.setText(_translate("ProfileIconWin", "Do you want to revert back to original avatar?"))
        self.firstName_label.setText(_translate("ProfileIconWin", "First name: "))
        self.firstName.setPlaceholderText(_translate("ProfileIconWin", "Renaming account is only for"))
        self.lastName_label.setText(_translate("ProfileIconWin", "Last name: "))
        self.lastName.setPlaceholderText(_translate("ProfileIconWin", "this app to recognize"))
        self.Rename_btn.setText(_translate("ProfileIconWin", "Rename account"))
        self.Title_label_2.setText(_translate("ProfileIconWin", "<html><head/><body><p align=\"center\"><a href=\"https://twitter.com/OfficialAhmed0\"><span style=\" font-family:\'verdana\'; font-size:14pt; text-decoration: underline; color:#90f542; vertical-align:super;\">Created By @OfficialAhmed0</span></a></p></body></html>"))
    ...
    def RenameAccount(self):
        ...
        try:
            ...
            ftp.login("", "")
            ftp.cwd("system_data/priv/cache/profile/" + self.user[self.currentUserCounter])
            ...
            self.Rename_btn.setText("All done (restart app)")
        except Exception as e:
