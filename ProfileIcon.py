...
class Ui_ProfileIconWin(object):
    def setupUi(self, ProfileIconWin, allUsers, IP, Port, w, h):
        ...
        self.avatar = ""
        self.iconPath = ""
        self.originalAvatar = self.AppSettingDir + "prxUserMeta\MegaSRX\metaprodata\\" + \
            self.user[self.currentUserCounter] + "Original.png"

        # v4.05 new UI
        ProfileIconWin.setObjectName("ProfileIconWin")
        ProfileIconWin.resize(1080, 720)
        ProfileIconWin.setWindowIcon(QtGui.QIcon(
            self.appPath + "\Data\Pref\ic1.@OfficialAhmed0"))
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            ProfileIconWin.sizePolicy().hasHeightForWidth())
        ProfileIconWin.setSizePolicy(sizePolicy)
        ProfileIconWin.setMinimumSize(QtCore.QSize(900, 670))
        self.formLayout = QtWidgets.QFormLayout(ProfileIconWin)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.WinTitle.sizePolicy().hasHeightForWidth())
        ...
        self.TopLayout.setWidget(
            0, QtWidgets.QFormLayout.LabelRole, self.WinTitle)
        self.line_2 = QtWidgets.QFrame(ProfileIconWin)
        self.line_2.setMinimumSize(QtCore.QSize(4000, 1))
        self.line_2.setStyleSheet("border-image: url(" + self.convert2Url(
            self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        self.line_2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_2.setLineWidth(1)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setObjectName("line_2")
        self.TopLayout.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.line_2)
        self.formLayout.setLayout(
            1, QtWidgets.QFormLayout.SpanningRole, self.TopLayout)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ProfileIcon.sizePolicy().hasHeightForWidth())
        self.ProfileIcon.setSizePolicy(sizePolicy)
        self.ProfileIcon.setMinimumSize(QtCore.QSize(300, 340))
        self.ProfileIcon.setStyleSheet("border-image: url(" + self.dataPath +
                                       "prxUserMeta//MegaSRX//metaprodata//" + str(self.user[0]) + ".png);")
        self.ProfileIcon.setObjectName("ProfileIcon")
        self.LeftLayout.addWidget(self.ProfileIcon)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Change_btn.sizePolicy().hasHeightForWidth())
        ...
        self.ResizeUpload_btn.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.formLayout.setLayout(
            2, QtWidgets.QFormLayout.LabelRole, self.LeftLayout)
        ...
        self.RightLayout.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.AccountID)
        self.line_3 = QtWidgets.QFrame(ProfileIconWin)
        self.line_3.setMinimumSize(QtCore.QSize(30, 3))
        self.line_3.setStyleSheet("border-image: url(" + self.convert2Url(
            self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.RightLayout.setWidget(
            2, QtWidgets.QFormLayout.SpanningRole, self.line_3)
        ...
        self.line_4.setStyleSheet("border-image: url(" + self.convert2Url(
            self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.RightLayout.setWidget(
            4, QtWidgets.QFormLayout.SpanningRole, self.line_4)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Originalcon.sizePolicy().hasHeightForWidth())
        self.Originalcon.setSizePolicy(sizePolicy)
        self.Originalcon.setMinimumSize(QtCore.QSize(0, 265))
        self.Originalcon.setStyleSheet("border-image: url(" + self.convert2Url(
            self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        self.firstName_label = QtWidgets.QLabel(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.firstName = QtWidgets.QLineEdit(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.firstName.sizePolicy().hasHeightForWidth())
        font.setPointSize(13)
        ...
        self.formLayout_3.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.firstName)
        self.lastName_label = QtWidgets.QLabel(ProfileIconWin)
        ...
        self.lastName = QtWidgets.QLineEdit(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.lastName.sizePolicy().hasHeightForWidth())
        font.setPointSize(13)
        ...
        self.formLayout_3.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.lastName)
        self.label1 = QtWidgets.QLabel(ProfileIconWin)
        font = QtGui.QFont()
        ...
        self.formLayout_3.setWidget(
            4, QtWidgets.QFormLayout.SpanningRole, self.label1)
        self.label2 = QtWidgets.QLabel(ProfileIconWin)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayout_3.setWidget(
            6, QtWidgets.QFormLayout.SpanningRole, self.label2)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Revert_btn.sizePolicy().hasHeightForWidth())
        ...
        self.formLayout_3.setWidget(
            8, QtWidgets.QFormLayout.LabelRole, self.Revert_btn)
        self.Rename_btn = QtWidgets.QPushButton(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.Rename_btn.sizePolicy().hasHeightForWidth())
        ...
        self.formLayout_3.setWidget(
            2, QtWidgets.QFormLayout.LabelRole, self.Rename_btn)
        self.line = QtWidgets.QFrame(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_6.setStyleSheet("border-image:url(" + self.convert2Url(
            self.AppSettingDir + "Pref\\White.@OfficialAhmed0") + ");")
        ...
        self.CreditsLayout.setSizeConstraint(
        ...
        self.Title_label_2 = QtWidgets.QLabel(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        self.SupportMe = QtWidgets.QLabel(ProfileIconWin)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.SupportMe.sizePolicy().hasHeightForWidth())
        ...
        ProfileIconWin.setStyleSheet(
            "background-image: url(" + self.convert2Url(self.AppSettingDir + "Pref\\" + background) + ");")
        ...
        if os.path.isfile(self.dataPath + "prxUserMeta//MegaSRX//metaprodata//" + self.user[self.currentUserCounter] + "Original.png"):
            self.Originalcon.setStyleSheet(
                "border-image: url(" + self.dataPath + "prxUserMeta//MegaSRX//metaprodata//" + self.user[self.currentUserCounter] + "Original.png);")
    ...
    def retranslateUi(self, ProfileIconWin):
        ...
        ProfileIconWin.setWindowTitle(_translate(
            "ProfileIconWin", "Iconit v" + str(self.ver)))
        self.WinTitle.setText(_translate("ProfileIconWin", "Change Avatar"))
        self.Change_btn.setText(_translate("ProfileIconWin", "Change Avatar"))
        self.Download_btn.setText(_translate(
            "ProfileIconWin", "Download Avatar"))
        self.Prev_btn.setText(_translate("ProfileIconWin", "Previous"))
        self.Next_btn.setText(_translate("ProfileIconWin", "Next"))
        self.ResizeUpload_btn.setText(_translate(
            "ProfileIconWin", "Resize && Upload"))
        self.AccountName.setText(_translate(
            "ProfileIconWin", self.getAccountName()))
        self.AccountID_label.setText(
            _translate("ProfileIconWin", "AccountID:"))
        self.TotalAccount_label.setText(
            _translate("ProfileIconWin", "Total Accounts"))
        self.Revert_btn.setText(_translate(
            "ProfileIconWin", "Revert to original"))
        self.label1.setText(_translate(
            "ProfileIconWin", "This is the Original Avatar."))
        self.label2.setText(_translate(
            "ProfileIconWin", "Do you want to revert back to original avatar?"))
        self.firstName_label.setText(
            _translate("ProfileIconWin", "First name: "))
        self.firstName.setPlaceholderText(_translate(
            "ProfileIconWin", ""))
        self.lastName_label.setText(
            _translate("ProfileIconWin", "Last name: "))
        self.lastName.setPlaceholderText(_translate(
            "ProfileIconWin", ""))
        self.Rename_btn.setText(_translate("ProfileIconWin", "Rename account"))
        self.Title_label_2.setText(_translate(
            "ProfileIconWin", "<html><head/><body><p align=\"center\"><a href=\"https://twitter.com/OfficialAhmed0\"><span style=\" font-family:\'verdana\'; font-size:14pt; text-decoration: underline; color:#90f542; vertical-align:super;\">Created By @OfficialAhmed0</span></a></p></body></html>"))
    ...
    def getAccountName(self):
        name = ""
        file = open(self.AppSettingDir + "prxUserMeta\MegaSRX\metaprodata\\" +
                    self.user[self.currentUserCounter] + ".json")
        reading = file.read()
        start = reading.find("firstName") + 12
        end = reading.find("lastName") - 3
    ...
    def UpdateInfo(self):
        try:
            if os.path.isfile(self.dataPath + "prxUserMeta//MegaSRX//metaprodata//" + self.user[self.currentUserCounter] + "Original.png"):
                ...
                self.Revert_btn.setEnabled(True)
                self.avatar = self.dataPath + "prxUserMeta//MegaSRX//metaprodata//" + \
                    self.user[self.currentUserCounter] + "Original.png"
            else:
                # Couldn't get original image from Sony server while caching
                self.Originalcon.setStyleSheet(
            ...
            self.ProfileIcon.setStyleSheet(
                "border-image: url(" + self.dataPath + "prxUserMeta//MegaSRX//metaprodata//" + self.user[self.currentUserCounter] + ".png);")
    ...
    def Download(self):
        ...
        try:
            ...
            path, _ = QtWidgets.QFileDialog.getSaveFileName(
                None, "Where to Download?", "MyProfileIcon.png", "PNG (*.png)", options=opt)
            if path:
                import shutil
                shutil.copyfile(self.AppSettingDir + "prxUserMeta\\MegaSRX\\metaprodata\\" +
                                self.user[self.currentUserCounter] + ".png", path)
        except Exception as e:
            self.logit(str(e), "error")
    ...
    def Change(self):
        ...
        try:
            ...
            path, _ = QtWidgets.QFileDialog.getOpenFileName(
                None, "Pick an image greater than (440x440) ...", "", "PNG(*.png);; jpg(*.jpg);; Jpeg(*.jpeg);; icon(*.ico);; DDS(*.dds)", options=opt)
            if path:  # not empty
                import PIL
                valid = False
    ...
    def resizeUpload(self):
        ...
        try:
            ...
            if self.CheckAvatar == False:
                ...
                shutil.copyfile(self.avatar, self.AppSettingDir +
                                "prxUserMeta\MegaSRX\metaprodata\\" + self.user[self.currentUserCounter] + ".png")
            elif self.CheckAvatar == True:
                self.avatar = self.AppSettingDir + "prxUserMeta\MegaSRX\metaprodata\\" + \
                    self.user[self.currentUserCounter] + "Original.png"
                shutil.copyfile(self.avatar, self.AppSettingDir +
                                "prxUserMeta\MegaSRX\metaprodata\\" + self.user[self.currentUserCounter] + ".png")
            ...
            self.ui.setupUi(self.windo, self.avatar, self.IP, self.Port,
                            "", "Profileit", "", self.user[self.currentUserCounter])
            self.windo.show()
        except Exception as e:
            self.logit(str(e), "error")
